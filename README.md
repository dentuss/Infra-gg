...
Work flows `<type>/<slug>` → `dev` → `master`; nothing else merges into
...
- Conventional Commits (`feat:`, `fix:`, `chore:`, …) — PR titles too
- Branch off `dev`; never commit directly to `master` or `dev`
